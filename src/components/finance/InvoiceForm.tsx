...
export default function InvoiceForm({
  ...
  const defaultValues = getInvoiceDefaultValues(initialData);
  ...
  useEffect(() => {
    const subtotal =
      watchItems?.reduce((acc, item) => acc + (item?.total || 0), 0) || 0;
        ...
        <main className="invoice-form__main">
          ...
          <div className="invoice-form__card">
            <header className="invoice-form__header">
              ...
              <h2 className="invoice-form__header-title">
          ...
          {/* Customer Card (Extracted Component) */}
          ...
          <div className="invoice-form__card">
            <header className="invoice-form__header">
              ...
              <button
                ...
                className="invoice-form__add-item-btn"
              >
                <Plus /> Agregar Item
              </button>
            </header>
            <div className="invoice-form__items-list">
                  ...
                  <div key={field.id} className="invoice-form__item-row">
                    ...
                    <div className="invoice-form__item-main">
                          ...
                          render={({ field: typeField }) => (
                            <div className="invoice-form__type-toggle">
                              <button
                                ...
                                className={cn(
                                  'invoice-form__type-toggle-btn',
                                  typeField.value === 'libro' &&
                                    'invoice-form__type-toggle-btn--active'
                                )}
                              >
                                <Book />
                              </button>
                        ...
                        {itemType === 'libro' ? (
                          <Controller
                            ...
                            render={({ field: bField }) => (
                              <BookSelect
                                value={bField.value}
                                onSelect={(b) => handleBookSelect(index, b)}
                              />
                            )}
                          />
                        ) : (
                      ...
                      <button
                        ...
                        className="invoice-form__item-remove"
                      >
                        <Trash2 />
                      </button>
                    </div>
                    ...
                    <div className="invoice-form__item-details">
                      <div className="invoice-form__item-detail invoice-form__item-detail--cc">
                        <Label className="invoice-form__item-detail-label">
                          C. Costo
                        </Label>
                        <Controller
                          control={form.control}
                        ...
                        <Controller
                          ...
                          render={({ field: pField }) => (
                            <NumericInput
                              value={pField.value}
                              onValueChange={(v) =>
                                handleItemChange(index, 'unitPrice', Number(v))
                              }
                        ...
                        <Controller
                          ...
                          render={({ field: dField }) => (
                            <NumericInput
                              value={dField.value}
                              onValueChange={(v) =>
                                handleItemChange(index, 'discount', Number(v))
                              }
              ...
              {fields.length === 0 && (
                <div className="invoice-form__empty-state">
                  No has agregado conceptos a esta factura.
                </div>
              )}
            </div>
          </div>
          ...
          <div className="invoice-form__card">
            ...
            <div className="p-4">
              <Textarea
                {...form.register('notes')}
                placeholder="Escribe aquí notas adicionales para administración..."
        ...
        <aside className="invoice-form__sidebar">
              ...
              <div className="summary-row summary-row--total">
                <div className="summary-row--total-content">
                  <span className="label">
                    Gran Total ({form.watch('currency')})
                  </span>
          ...
          <div className="invoice-form__actions-container">
            ...
            <button
              type="submit"
              disabled={loading}
              className="invoice-form__submit-btn"
            >
              {loading ? (
                'Sincronizando...'
              ) : (
          ...
          {(form.watch('dianData.invoiceAuthorization') ||
            form.watch('cufe')) && (
            <div className="invoice-form__dian-panel">
              <div className="invoice-form__dian-header">
                ...
                <span className="invoice-form__dian-title">
                  Firma Electrónica DIAN
                </span>
              </div>
              <div className="invoice-form__dian-content">
                <div className="invoice-form__dian-field">
                  <span className="invoice-form__dian-label">
                    ID Autorización
                  </span>
                  <code className="invoice-form__dian-value">
                    {form.watch('dianData.invoiceAuthorization')}
                  </code>
                </div>
                <div className="invoice-form__dian-field">
                  ...
                  <p className="invoice-form__dian-text">
                    <span className="invoice-form__dian-code">
                      [{form.watch('dianData.validationResponse.code')}]
                    </span>{' '}
                    {form.watch('dianData.validationResponse.description')}
                  </p>
                </div>
              </div>
            </div>
