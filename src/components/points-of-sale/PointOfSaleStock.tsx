...
export function PointOfSaleStock({ warehouseId }: PointOfSaleStockProps) {
    ...
    return (
      <div className="pos-stock__empty">
        ...
        <p className="pos-stock__empty-text">
          Este punto de venta aún no tiene una bodega asociada para gestionar
          inventario.
        </p>
        <div className="pos-stock__empty-actions">
          <Button variant="outline" asChild>
            <Link href="/dashboard/warehouses/new">Crear Nueva Bodega</Link>
          </Button>
  ...
  if (loading)
    return <div className="pos-stock__loading">Cargando inventario...</div>;
      ...
      <div className="pos-stock__grid">
        <Card>
          <CardHeader className="pos-stock__stat-header">
            <CardTitle className="pos-stock__stat-title">
              Total Productos
            </CardTitle>
            ...
            <CardContent>
              <div className="pos-stock__warehouse-info-row">
                <div>
                  ...
                  <p className="pos-stock__warehouse-code">
                ...
                <Button variant="ghost" size="sm" asChild>
                  <Link href={`/dashboard/warehouses/${warehouseId}`}>
                    Gestionar{' '}
                    <ExternalLink className="pos-stock__external-icon" />
                  </Link>
                </Button>
              </div>
            </CardContent>
